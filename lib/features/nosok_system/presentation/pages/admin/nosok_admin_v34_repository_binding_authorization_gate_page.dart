...
class NosokAdminV34RepositoryBindingAuthorizationGatePage
    extends ConsumerWidget {
  const NosokAdminV34RepositoryBindingAuthorizationGatePage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return pack.when(
      ...
      data: (data) => ListView(
        ...
        children: [
          PwfSisSystemHero(
            title: 'Nosok v34 — Repository Binding Authorization Gate',
            description:
                'بوابة منع ربط المستودعات التشغيلية قبل اكتمال wrapper/RPC وUAT evidence.',
