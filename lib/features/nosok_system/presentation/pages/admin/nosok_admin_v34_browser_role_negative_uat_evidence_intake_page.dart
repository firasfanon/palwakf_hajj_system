...
class NosokAdminV34BrowserRoleNegativeUatEvidenceIntakePage
    extends ConsumerWidget {
  const NosokAdminV34BrowserRoleNegativeUatEvidenceIntakePage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return pack.when(
      ...
      data: (data) => ListView(
        ...
        children: [
          PwfSisSystemHero(
            title: 'Nosok v34 — Browser/Role Negative UAT Evidence Intake',
            description:
                'استيعاب أدلة المتصفح والأدوار بعد تطبيق public wrappers/RPCs.',
