...
class NosokAdminV32ProductionGateRedecisionPage extends ConsumerWidget {
  const NosokAdminV32ProductionGateRedecisionPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return pack.when(
      ...
      data: (data) => ListView(
        ...
        children: [
          PwfSisSystemHero(
            title: 'Nosok v32 — Production Gate Re-decision',
            description:
                'إعادة قرار الإنتاج: غير معتمد بسبب عدم تنفيذ controlled apply ووجود blocker runtime CanvasKit.',
