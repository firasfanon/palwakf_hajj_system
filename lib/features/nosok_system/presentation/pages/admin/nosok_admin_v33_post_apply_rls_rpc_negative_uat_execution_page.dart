...
class NosokAdminV33PostApplyRlsRpcNegativeUatExecutionPage
    extends ConsumerWidget {
  const NosokAdminV33PostApplyRlsRpcNegativeUatExecutionPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return pack.when(
      ...
      data: (data) => ListView(
        ...
        children: [
          PwfSisSystemHero(
            title: 'Nosok v33 — Post-Apply RLS/RPC Negative UAT Execution',
            description:
                'تنفيذ/استيعاب مصفوفة UAT السلبية بعد إنشاء nosok.* وتفعيل RLS.',
