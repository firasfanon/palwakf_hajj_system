...
class NosokAdminV32ControlledStagingDdlApplyEvidencePage
    extends ConsumerWidget {
  const NosokAdminV32ControlledStagingDdlApplyEvidencePage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return pack.when(
      ...
      data: (data) => ListView(
        ...
        children: [
          PwfSisSystemHero(
            title: 'Nosok v32 — Controlled Staging DDL Apply Evidence Intake',
            description:
                'استيعاب نتائج read-only وبيان أن controlled apply لم يثبت بعد، مع تحديد ترتيب التشغيل الآمن للملفات.',
