-- Nosok v34 — Public Wrapper/RPC Authorization Read-Only Gate
-- Safe to run. No DDL/DML. Does not create public base tables.

with schema_presence as (
  select jsonb_build_object(
    'decision', 'NOSOK_V34_PUBLIC_WRAPPER_RPC_AUTHORIZATION_READ_ONLY',
    'read_only', true,
  ...
  select jsonb_build_object(
    'decision', 'NOSOK_V34_WRAPPER_APPLY_AUTHORIZATION_REQUIRED_OPERATOR_ONLY',
    'read_only', true,
...
union all select '03_existing_wrapper_status', payload from existing_wrapper_status
