-- Nosok v35 — Public Wrapper/RPC Surface Controlled Staging Apply
-- STATUS: AUTHORIZED_STAGING_ONLY / OPERATOR CONTROLLED
-- authorization_intent: USER_AUTHORIZED_NOSOK_V35_PUBLIC_WRAPPER_RPC_STAGING_APPLY
-- staging_target: Supabase staging database only
-- backup_reference: REQUIRED_OPERATOR_FILLED_BEFORE_EXECUTION
-- operator_identity: REQUIRED_OPERATOR_FILLED_BEFORE_EXECUTION
