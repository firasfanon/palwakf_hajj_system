...
class UserDashboardContractBuilder {
  ...
  static UserDashboardContract build({
    ...
    return UserDashboardContract(
      ...
      isSuperuser: profile?.isSuperuser ?? user.isProtectedSuperuser,
  ...
  static String _policyRoleKey(
    ...
    if (user.isProtectedSuperuser || (profile?.isSuperuser ?? false))
      return 'superuser';
  ...
  static String _routeFor(SystemKey key) {
    switch (key) {
      ...
      case SystemKey.nosok:
        return AppRoutes.adminNosok;
    }
  }
}
